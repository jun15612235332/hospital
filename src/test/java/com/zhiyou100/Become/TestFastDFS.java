...
public class TestFastDFS {
	...
	public static void main(String[] args) throws IOException, MyException {
		...
		meta_list[0] = new NameValuePair("fileName", "背景图片.jpg");

		// 5. 上传文件
		/*
		 * 参数1:要上传的文件地址 参数2:要上传的文件类型 参数3:文件属性信息对象数组 返回值 : 存储在Storage中的地址
		 */
		String path = storageClient.upload_file1("C:\\Users\\Public\\Pictures\\Sample Pictures\\背景图片.jpg", "jpg", meta_list);
